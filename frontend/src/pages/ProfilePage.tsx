...
export function ProfilePage() {
  ...
  const initials = user.avatar?.trim() || getUserInitials(user)
      ...
      <div className="grid gap-6 lg:grid-cols-3">
        <Card className="lg:col-span-2">
          ...
          <CardContent className="space-y-1">
            ...
            <InfoRow icon={Building2} label="Département" value={user.department || "Non renseigné"} />
        ...
        <Card>
          <CardHeader>
            ...
            <CardDescription>Accès attribué à votre compte.</CardDescription>
          </CardHeader>
          <CardContent>
