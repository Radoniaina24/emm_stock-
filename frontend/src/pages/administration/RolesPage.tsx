          ...
          <div className="flex flex-col">
            <div className="bg-gradient-to-br from-indigo-600 to-violet-700 px-5 py-6 text-white">
              <div className="flex items-center gap-3">
                ...
                <div>
                  ...
                  <p className="text-sm text-white/70">{selectedRole?.code}</p>
                </div>
              </div>
              <div className="mt-3 flex items-center gap-2">
                {selectedRole?.isSystem ? (
                  <Badge variant="secondary" className="bg-amber-400/20 text-amber-200 border-0">
                    <ShieldCheck className="size-3 mr-1" /> Système
                  </Badge>
                ) : (
                ...
                <Badge variant="secondary" className={`border-0 ${selectedRole?.isActive ? "bg-emerald-400/20 text-emerald-200" : "bg-white/10 text-white/50"}`}>
            ...
            <div className="space-y-4 p-5">
              <div className="space-y-1">
                ...
                <p className="text-sm text-foreground/80">{selectedRole?.description ?? "Aucune description"}</p>
              </div>

              <div className="space-y-1">
                <p className="text-[10px] font-semibold uppercase tracking-wider text-muted-foreground/60">Permissions</p>
