...
const departments_controller_js_1 = require("./departments.controller.js");
...
exports.DepartmentsModule = DepartmentsModule = __decorate([
    (0, common_1.Module)({
        controllers: [departments_controller_js_1.DepartmentsController],
        providers: [departments_service_js_1.DepartmentsService],
    })
], DepartmentsModule);
