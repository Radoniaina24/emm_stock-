...
const create_role_dto_js_1 = require("./dto/create-role.dto.js");
...
__decorate([
    ...
    (0, swagger_1.ApiOkResponse)({ description: 'Rôle créé' }),
    __param(0, (0, common_1.Body)()),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [create_role_dto_js_1.CreateRoleDto]),
    __metadata("design:returntype", void 0)
], RolesController.prototype, "create", null);
__decorate([
    (0, common_1.Get)(),
    (0, swagger_1.ApiOperation)({ summary: 'Liste des rôles' }),
    (0, swagger_1.ApiOkResponse)({ description: 'Liste des rôles' }),
    __metadata("design:type", Function),
...
__decorate([
    ...
    (0, swagger_1.ApiOkResponse)({ description: 'Rôle trouvé' }),
...
__decorate([
    ...
    (0, swagger_1.ApiOkResponse)({ description: 'Rôle modifié' }),
    __param(0, (0, common_1.Param)('id')),
...
__decorate([
    ...
    (0, swagger_1.ApiOkResponse)({ description: 'Rôle supprimé' }),
    __param(0, (0, common_1.Param)('id')),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [String]),
    __metadata("design:returntype", void 0)
