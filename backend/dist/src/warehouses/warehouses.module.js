...
const warehouses_controller_js_1 = require("./warehouses.controller.js");
...
exports.WarehousesModule = WarehousesModule = __decorate([
    (0, common_1.Module)({
        controllers: [warehouses_controller_js_1.WarehousesController],
        providers: [warehouses_service_js_1.WarehousesService],
    })
], WarehousesModule);
