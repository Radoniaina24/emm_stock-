...
__decorate([
    (0, common_1.Post)(),
    (0, swagger_2.ApiOperation)({ summary: 'Créer un nouvel utilisateur' }),
...
__decorate([
    (0, common_1.Get)(),
    (0, swagger_2.ApiOperation)({ summary: 'Liste de tous les utilisateurs' }),
    (0, swagger_2.ApiOkResponse)({ description: 'Liste des utilisateurs' }),
    __metadata("design:type", Function),
...
__decorate([
    ...
    (0, swagger_2.ApiOkResponse)({ description: 'Utilisateur authentifié avec profil' }),
    (0, swagger_2.ApiUnauthorizedResponse)({ description: 'Non authentifié' }),
...
__decorate([
    ...
    (0, swagger_2.ApiBody)({ type: update_profile_dto_js_1.UpdateProfileDto }),
    (0, swagger_2.ApiOkResponse)({ description: 'Profil mis à jour' }),
    __param(0, (0, current_user_decorator_js_1.CurrentUser)('id')),
...
__decorate([
    ...
    (0, swagger_2.ApiOperation)({ summary: 'Uploader / remplacer la photo de profil' }),
    ...
    (0, swagger_2.ApiOkResponse)({ description: 'Profil mis à jour avec la nouvelle photo' }),
...
__decorate([
    ...
    (0, swagger_2.ApiOperation)({ summary: 'Supprimer la photo de profil' }),
    (0, swagger_2.ApiOkResponse)({ description: 'Photo supprimée' }),
    __param(0, (0, current_user_decorator_js_1.CurrentUser)('id')),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [String]),
    __metadata("design:returntype", void 0)
...
exports.UsersController = UsersController = __decorate([
    (0, swagger_2.ApiTags)('users'),
    (0, swagger_2.ApiCookieAuth)('token'),
